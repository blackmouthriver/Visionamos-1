...
import { Name, Frecuencia } from "../createForm/createFormStyles";
...
function UpdateForm({
    ...
    if (
     ...
     if (newinput.name === "") {
      ...
      const response = await axios.put(
        `http://localhost:3001/comprobantes/actualizar/${id}`,
        newinput
      );
  ...
  const ShowModal = () => {
    if (sendModal) {
      return (
        <ModalRespuesta
          titleody="El comprobante ha sido actualizado con éxito"
  ...
  console.log(errors, "linea 500")
  return (
    <div>
      <NavInterna />
      <>
        <div className="comprobante_creado">
          <Name className="name">EDITAR COMPROBANTE</Name>
          <form
          ...
          >
            ...
            <div className="comprobante_creado_nombre">
              ...
              <div className="comprobante_creado_nombre_">
                <input
                  ...
                  name="vaucher"
                  type="text"
                  placeholder={`Numero del último Comprobante ${ultimoComprobante?.vaucher}`}
                  required
            ...
            <div className="comprobante_creado_nombre">
              ...
              <div className="comprobante_creado_nombre_">
                <input
                  ...
                  type="text"
                  label="Comprobante"
                  placeholder={`Numero de Secuencia ${ultimoComprobante?.sequence}`}
                  required
              ...
              {errors.sequence === undefined || errors.sequence === "" ? (
                <p className="info">
                  Se indica el consecutivo en el que empezará almacenarse los
            ...
            <div className="comprobante_creado_nombre">
              <label className="comporbante_nombre">Tipo De Comprobante *</label>
              <div className="comprobante_creado_nombre_">
                <select
                  required
            ...
            {/*<Frecuencia>
              <div>
                <div className="row">
                  <div className="col-sm-8 toggleTitle">
                    <h6>Reiniciar secuencia a fin de Mes</h6>
                  </div>
                 ...
                 <div className="col-sm-2">
                    <FontAwesomeIcon className="iconInfo" icon={faInfoCircle} />{" "}
                  </div>
                </div>

                <div className="row">
                  <div className="col-sm-8 toggleTitle">
                    <h6>Comprobante Automático</h6>
                  </div>
